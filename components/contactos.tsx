const Contactos = () => {
    ...
    return(
        <ul className="Contenedor de contactos flex flex-wrap align-center items-center grow-1">
            <li id="whatsapp" className="flex justify-center pr-12"> 
                <a href="https://wa.me/+528110596823" target="_blank" rel="noreferrer">
                    ...
                    <span className="md:inline-block ml-2 text-white md:visible">+52 81 1059 6823</span>
                </a>
            </li>
            <li id="facebook" className="flex justify-center pr-12">
                <a href="https://www.facebook.com/macanazoscaricaturasocial" target="_blank" rel="noreferrer">
                    ...
                    <span className="md:inline-block ml-2 text-white md:visible">Macanazos caricatura social.</span>
                </a>
            </li>
            <li id="instagram" className="flex justify-center pr-12">
                ...
                <span className="md:inline-block ml-2 text-white md:visible">@macanazos.caricaturasocial</span>
                
                </a>
            </li>

            <li id="email" className="flex justify-center pr-12">
                ...
                <span className="md:inline-block ml-2 text-white md:visible">castillo.memo@gmail.com</span>
                </a>
            </li>
