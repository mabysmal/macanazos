        ...
        <ul className="Contenedor de contactos justify-center flex flex-wrap w-[30%] md:[10%] flex-col text-2xl">
            ...
            <li id="facebook" className="flex pr-12 mb-4">
                <a href="https://www.facebook.com/macanazoscaricaturasocial" target="_blank" rel="noreferrer">
                    <svg className="inline-block" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="#fffff7" d="M13.397 20.997v-8.196h2.765l.411-3.209h-3.176V7.548c0-.926.258-1.56 1.587-1.56h1.684V3.127A22.336 22.336 0 0 0 14.201 3c-2.444 0-4.122 1.492-4.122 4.231v2.355H7.332v3.209h2.753v8.202z"/></svg>
