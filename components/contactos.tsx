const Contactos = () => {
    ...
    return(
        <ul className="Contenedor de contactos justify-center flex flex-wrap w-[30%] md:[10%] flex-col ">
            <li id="whatsapp" className="flex pr-12 mb-4"> 
                <a href="https://wa.me/+528110596823" target="_blank" rel="noreferrer">
                    ...
                    <span className="hidden md:inline-block ml-2 text-white md:visible">+52 81 1059 6823</span>
                </a>
            </li>
            <li id="facebook" className="flex pr-12 mb-4">
                <a href="https://www.facebook.com/macanazoscaricaturasocial" target="_blank" rel="noreferrer">
                    ...
                    <span className="hidden md:inline-block ml-2 text-white md:visible">Macanazos caricatura social.</span>
                </a>
            </li>
            <li id="instagram" className="flex pr-12 mb-4">
                ...
                <span className="hidden md:inline-block ml-2 text-white md:visible">@macanazos.caricaturasocial</span>
            ...
            <li id="email" className="flex  pr-12 mb-4">
                ...
                <span className="hidden md:inline-block ml-2 text-white md:visible">castillo.memo@gmail.com</span>
                </a>
            </li>
