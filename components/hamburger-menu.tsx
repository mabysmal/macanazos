    ...
    return (
        ...
        <div className="relative md:static md:flex md:bg-orange md:justify-center">
            <ul id="mobileMenu" className="absolute top-0 left-0 ml-6 mt-8 md:static md:flex md:m-2">
                ...
                <li><a className="h-full px-8 no-underline hidden items-center font-font-bebas text-2xl md:flex md:text-white md:overflow-hidden md:max-w-xs md:transition md:duration-300 md:ease-in-out md:hover:scale-150" href="macanazos.memaxo.art"><h2 className={bebasNeue.className}>Inicio</h2></a></li>
